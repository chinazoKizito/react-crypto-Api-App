...
const CryptoDetails = () => {
  ...
  const genericStats = [
    ...
    { title: 'Circulating Supply', value: `$ ${millify(cryptoDetails.supply.supplyAt)}`, icon: <ExclamationCircleOutlined /> },
  ];
      ...
      <Col className='stats-container'>
          ...
          <Col className='other-stats-info'>
              <Col className='coin-value-statistics-heading'>
                ...
                <p>An overview showing other stats of {cryptoDetails.name}</p>
              </Col>
